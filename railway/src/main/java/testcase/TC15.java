...
public class TC15 extends BaseTest {
    ...
    @Test
    public void TC15() {
        BaseTest.extentTest = BaseTest.extentReports.createTest("TC15-User can open \"Book ticket\" page by clicking on \"Book ticket\" link in \"Train timetable\" page");
        ...
        Log.logInfo("STEP 3: Click on \"Timetable\" tab.");
        BasePage.goToTab(BasePage.getTimetableTab());

        //STEP 4: Click on "book ticket" link of the route
        Log.logInfo("STEP 4: Click on \"book ticket\" link of the route.");
